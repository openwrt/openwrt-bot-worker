...
// exhaust the real cap while still believing it had headroom left (see
// subrequestBudget in index.js). Returning `false` from it declines the
// attempt: the request is not made and the last answer is returned as is, or,
